...
lazy val mimaSettings = Seq(
  ...
  mimaBinaryIssueFilters ++= {
    ...
    Seq(
      ...
      ProblemFilters.exclude[ReversedMissingMethodProblem]("fs2.kafka.ProducerSettings.withRequestTimeout"),
      ProblemFilters.exclude[ReversedMissingMethodProblem]("fs2.kafka.ProducerSettings.withLinger")
    )
    // format: on
  }
)
