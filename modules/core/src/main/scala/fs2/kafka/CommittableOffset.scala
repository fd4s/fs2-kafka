...
/** [[CommittableOffset]] represents an [[offsetAndMetadata]] for a [[topicPartition]], along with
  ...
  * [[CommittableOffsetBatch]] to commit the offsets in batches.<br> <br> While normally not
  * necessary, [[CommittableOffset#apply]] can be used to create a new instance.
  */
sealed abstract class CommittableOffset[F[_]] {
  ...
  /** The consumer group ID of the consumer that fetched the [[offsetAndMetadata]] from the
    * [[topicPartition]] from Kafka.<br> <br> Required for committing offsets within a transaction.
    */
