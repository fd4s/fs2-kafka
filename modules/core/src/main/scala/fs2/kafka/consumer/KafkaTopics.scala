...
trait KafkaTopics[F[_]] {
  ...
  /** Returns the first offset for the specified partitions.<br> <br> Timeout is determined by
  ...
  /** Returns the last offset for the specified partitions.<br> <br> Timeout is determined by
    * `request.timeout.ms`, which is set using [[ConsumerSettings#withRequestTimeout]].
    */
